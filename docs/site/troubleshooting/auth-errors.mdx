...
keywords: ["authsome 401", "authsome 403", "authsome token expired", "authsome scopes", "authsome revoke", "authsome advanced remove", "authsome auth error"]
---
...
```bash
authsome advanced remove <provider>
authsome login <provider>
```
