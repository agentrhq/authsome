...
```bash
authsome advanced log              # last 50 entries, pretty-printed
authsome advanced log -n 200       # last 200
authsome advanced log --json       # one JSON object per line, unmodified
```
