...
## [0.7.0](https://github.com/agentrhq/authsome/compare/authsome-v0.6.3...authsome-v0.7.0) (2026-06-09)
...
* add dashboard applications and identity pages ([6a059c6](https://github.com/agentrhq/authsome/commit/6a059c6bffd9800a5129430aa07ea69859a7b762))
...
* **evals:** add generate_report.py — HTML eval report generator ([6ad8b66](https://github.com/agentrhq/authsome/commit/6ad8b66a75c0079bfcf71fd9cbeddfe0465b4b67))
* **evals:** add run_evals.py — agent runner and LLM judge ([b779855](https://github.com/agentrhq/authsome/commit/b77985512b36f0ba1c3b007f8c3328d46cb1a0c8))
...
* **evals:** complete eval runner pipeline, smoke-tested with eval 1 ([d64524e](https://github.com/agentrhq/authsome/commit/d64524eecf2de5feade60a211b48b8a8afd5bdef))
...
* **evals:** rewrite evals.json with new 7-test schema ([af97892](https://github.com/agentrhq/authsome/commit/af9789299e5707f69b6daee829be666b6690088d))
...
* implement master key rotation via rekey command and API endpoint ([3c80c7e](https://github.com/agentrhq/authsome/commit/3c80c7e01eed42aa00d5d641108e33949ff5dbb0))
...
* **proxy:** configurable intercept scope and unmatched policy ([9878be8](https://github.com/agentrhq/authsome/commit/9878be8994e781b2866dbf984c2cd97b0d2b4ef9))
* **proxy:** configurable mode CLI + provider hint in deny body ([255a2db](https://github.com/agentrhq/authsome/commit/255a2db2e3b874ebd5fd2f699d0c32ca62a5d2a5))
* **proxy:** include provider name and dashboard URL in 403 deny body ([ae0291b](https://github.com/agentrhq/authsome/commit/ae0291b0cacf93196bebb502ad779a623307f4cf))
* redesign dashboard provider and connection flows ([438c69f](https://github.com/agentrhq/authsome/commit/438c69f00effe41383878ecb72e9978194955591))
...
* scope connections to vault, add claim flow and principal concept, confine UI session to principal view, and make vault/identity/principal orthogonal ([923cc93](https://github.com/agentrhq/authsome/commit/923cc93aca0b44bc7311ecae779b58c5249d5121))
...
* support env-backed runtime identities ([3ce32f9](https://github.com/agentrhq/authsome/commit/3ce32f9384247c410c5759db6da168fc25a74177))
...
* client secret field made default ([8268d6a](https://github.com/agentrhq/authsome/commit/8268d6a89dd5cf3111d7843c38b42f0f4b5e0eef))
...
* **docs:** align README, plugin, and docs with source-of-truth ([b8ea952](https://github.com/agentrhq/authsome/commit/b8ea9526fde9c510de2ecb1ab4ff8eabf5632791))
* **docs:** align README, plugin, and docs with source-of-truth ([cdf3de8](https://github.com/agentrhq/authsome/commit/cdf3de8456bf7b4f3229602e0b4f4e7285ea1ca2))
...
* normalize cli error handling for json output ([1bbe08f](https://github.com/agentrhq/authsome/commit/1bbe08fdfebcc182874b9a7a2423c2ca461f5e31))
...
* **proxy:** restore structured audit events on deny ([b29f30b](https://github.com/agentrhq/authsome/commit/b29f30b6a94c880762556b40107d1e067e7892cf))
* **proxy:** use load_server_config after LocalAppStore.get_config removal ([a929bea](https://github.com/agentrhq/authsome/commit/a929bea9666e4a5ff86486f74d206159f4c126c5))
...
* replaced audit for logger ([240180f](https://github.com/agentrhq/authsome/commit/240180f6e44e9340bda73a15f1b319f1ea4bf382))
...
* ruff check ([be4b362](https://github.com/agentrhq/authsome/commit/be4b3626a901c5d08c9ef4950d3cf814ccd4f7e5))
* ruff check ([08a29ff](https://github.com/agentrhq/authsome/commit/08a29fffa7ffc1f67033150fedef92268b288ef4))
* ruff check ([72260f9](https://github.com/agentrhq/authsome/commit/72260f9929d16e682bbb55b721987d5ca04922f5))
...
* add Authsome UI design spec ([0a9592f](https://github.com/agentrhq/authsome/commit/0a9592fcc83a1869435a0b11976ab6f036ed816b))
...
* add env-backed identity design spec ([4ea0717](https://github.com/agentrhq/authsome/commit/4ea0717fe88daa63a3cc0c2a6d1079c6a39710d8))
...
* **evals:** add setup.md — pre-run fresh install guide ([d91b34e](https://github.com/agentrhq/authsome/commit/d91b34e6b6ff9b7fbeaedc26d9525a29ace7d1e1))
...
* introduce Principal concept, retire Profile, add Claim flow ([71479a6](https://github.com/agentrhq/authsome/commit/71479a6de9656515f44273e6e45435449784ecaf))
* introduce Vault as first-class entity with VaultHandle and three-registry model ([d0b704e](https://github.com/agentrhq/authsome/commit/d0b704e85e73fe1fff56ec0827a0c920788e96c5))
...
* refine Authsome UI design flows ([9b59a6d](https://github.com/agentrhq/authsome/commit/9b59a6db2a4480306cd0fc4f2367ccb1a2c28255))
